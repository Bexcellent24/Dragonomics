 ...
 *
 * Updated to use String (Firebase UID) instead of Long (Room userId)
 */
...
class SessionStore(private val context: Context) {
     ...
     * @param id Firebase UID (String) or null to clear session
     */
    ...
    /**
     * Get the current user ID synchronously (blocks)
     * For reactive access, use the userId Flow instead
     */
